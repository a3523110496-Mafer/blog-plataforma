# Plataforma Web de Publicaciones y Blog

## Descripción del proyecto
Este proyecto consiste en el desarrollo de una aplicación web orientada a la publicación y visualización de contenido tipo blog.  
La plataforma permitirá a los usuarios crear, administrar y consultar publicaciones de manera organizada, accesible y segura, diferenciando entre contenido público y contenido gestionado por usuarios autenticados.
...
El problema identificado es la falta de plataformas sencillas que permitan:
- Publicar contenido propio de forma estructurada
- Mantener control sobre quién puede crear o modificar publicaciones
...
- Es accesible desde cualquier navegador sin instalación
- Permite una separación clara entre frontend y backend
...
- **Frontend:**  
  Interfaz de usuario encargada de la visualización del contenido y la interacción con el sistema, considerando navegación por teclado y accesibilidad.

- **Backend:**  
  Lógica de la aplicación, gestión de usuarios, publicaciones y autenticación.
